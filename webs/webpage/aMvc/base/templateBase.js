...
class ChaserTemp {
    ...
    createList(info2, arg, eventHandler) {
        ...
        var grouparr = info2.grouparr;
        //console.log(arg);
        var mediaE = $(`<div class="card-deck2">
                        </div>`);
    ...
    createViewbody(info2, arg, eventHandler) {
        ...
        var plusBrdid = 1;
        var brdid = Number(info.uid.toString().padEnd(5, "0")); //erp 에서 호출시
        //var brdid = Number(info.uid.toString().padEnd(6, "0"));  //board 에서 호출시

        ver.addControl(alert);
        var tboard = new BoardController({
            type: 'boardlist',
            dbpath: arg.dbpath,
            code: "da_board",
            title: '타임라인',
        ...
        ver.addControl(tboard);
        
        var board1 = new BoardController({
            type: 'boardlist',
            dbpath: arg.dbpath,
            code: "da_employee",
            brdid: brdid + plusBrdid++,
        ...
        var board2 = new BoardController({
            type: 'boardlist',
            dbpath: arg.dbpath,
            code: "da_employee",
            brdid: brdid + plusBrdid++,
        ...
        var erp = new ErpController({
            ...
            tag: 'board-' + info.uid,
            viewbody: 'EmployeeViewbodyTemplate'
        });

        var comerp = new ErpController({
            type: 'erplist',
            dbpath: arg.dbpath,
            code: 'company',
            title: '회사',
            ...
            rendertype: 'selectlist_h',
            //viewbody: 'CompanyViewbodyTemplate'
            viewbodytype: 'full'
        });
        ...
        main.addControl(erp);
        main.addControl(comerp);
        main.addControl(board);
